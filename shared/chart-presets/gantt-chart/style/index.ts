...
const agCustom: Partial<GanttChartCustom<GanttChartConfig>> = {
    ...
    SizedBox({
      ...
      child: LayoutBuilder({
        builder: (_ctx, constraints) => {
          ...
          const color = ctx.config.colors.fills[colorIndex % ctx.config.colors.fills.length];
          ...
          painter: {
            ...
            svg: {
              ...
              paint: ({ dependency }, size) => {
                ...
                dependency.setAttribute("stroke-dasharray", "4 3");
              },
            },
            canvas: {
              paint: (context, size) => {
