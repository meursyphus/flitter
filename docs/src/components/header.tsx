...
import { ecosystemNav, chartNav, advancedNav } from "@/lib/navigation";
import FlitterLogo from "./flitter-logo";
import Sidebar from "./sidebar";

function useSidebarNav(pathname: string) {
  if (pathname.startsWith("/chart")) {
    return chartNav;
  }
  if (pathname.startsWith("/advanced")) {
    return { sections: advancedNav };
  }
  return ecosystemNav;
}
...
export default function Header() {
  ...
  const sidebarNav = useSidebarNav(pathname);
    ...
    <>
      ...
      {menuOpen && (
        <div className="fixed inset-0 z-[100] md:hidden">
          ...
          <nav className="absolute right-0 top-0 h-full w-72 bg-white shadow-lg border-l border-gray-200 flex flex-col">
            ...
            <div className="shrink-0 border-t border-gray-100 px-4 py-3">
              <div className="flex items-center gap-2">
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="Open GitHub"
                  className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md border border-gray-200 text-gray-700 hover:bg-gray-50"
                >
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="Join Discord"
                  className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md border border-gray-200 text-[#5865F2] hover:bg-gray-50"
                >
