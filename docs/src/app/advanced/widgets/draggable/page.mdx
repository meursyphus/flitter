export const metadata = { title: "Draggable", description: "Guide to using the Draggable widget for creating draggable widgets" };
...
```typescript
import { Draggable, Container } from 'flitter-ui';
...
```typescript
import { Draggable, Container, Text } from 'flitter-ui';
...
```typescript
import { StatefulWidget, State, Draggable, Container, Transform } from 'flitter-ui';
...
```typescript
import { Draggable, Container, Text, Opacity } from 'flitter-ui';
...
```typescript
import { Column, Draggable, Container, Text, EdgeInsets } from 'flitter-ui';
...
```typescript
import { Draggable, Container, Text, Column } from 'flitter-ui';
