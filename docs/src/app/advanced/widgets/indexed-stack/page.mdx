export const metadata = { title: "IndexedStack", description: "Guide to using the IndexedStack widget for displaying one child from multiple children" };
...
```typescript
import { IndexedStack, Container, Text } from 'flitter-ui';
...
```typescript
import { StatefulWidget, State, IndexedStack, Container, Text, Column, Button } from 'flitter-ui';
...
```typescript
import { StatefulWidget, State, IndexedStack, Column, TextField, Text } from 'flitter-ui';
...
```typescript
import { IndexedStack, Container, Text, StackFit } from 'flitter-ui';
...
```typescript
import { IndexedStack, Container, Text, Alignment } from 'flitter-ui';
...
```typescript
import { StatefulWidget, State, IndexedStack, AnimatedContainer, Text } from 'flitter-ui';
...
```typescript
import { StatefulWidget, State, IndexedStack, Column, Text, Button, Row } from 'flitter-ui';
