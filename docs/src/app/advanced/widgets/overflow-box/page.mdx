export const metadata = { title: "OverflowBox", description: "A widget that imposes different constraints on its child than it gets from its parent, possibly allowing overflow" };
