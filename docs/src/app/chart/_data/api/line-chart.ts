...
export const lineChartApiPage: ApiPageData = {
  slug: ["api", "line-chart"],
  ...
  customParts: [
    { element: "line", args: "{ values: number[]; legend: string; index: number; isHovered: boolean }", description: "The line path element for a single series." },
    ...
    { element: "dataView", args: "{ lines: Widget[] }", description: "Container for all line widgets in the data area." },
  ...
  overrideExample: `import { ToastLineChart } from "@/components/flitter/charts/toast-line-chart";
