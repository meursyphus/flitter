...
export function VerticalAgBarChart() {
  return <AgBarChart direction="vertical" data={defaultData} />;
}

export function HorizontalAgBarChart() {
  return <AgBarChart direction="horizontal" data={defaultData} />;
}

export function NegativeVerticalAgBarChart() {
  return <AgBarChart direction="vertical" data={negativeData} />;
}

export function NegativeHorizontalAgBarChart() {
  return <AgBarChart direction="horizontal" data={negativeData} />;
}
