...
import { BasicHeatmapToast, ServerLoadToast, CorrelationMatrixToast, GithubActivityToast } from "./examples.generated";
...
export const toastStyle: StylePageData = {
  ...
  examples: [
    ...
    {
      title: "Server Load",
      chart: <ServerLoadToast.Component />,
      code: ServerLoadToast.code,
    },
    {
    ...
    },
    {
      ...
      chart: <GithubActivityToast.Component />,
      code: GithubActivityToast.code,
    },
  ],
};
