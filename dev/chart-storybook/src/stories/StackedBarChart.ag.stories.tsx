...
function AgStackedBarChart({ args, data }: { args: StackedBarChartArgs; data: typeof defaultData }) {
...
export const Vertical: Story = {
  render: (args) => <AgStackedBarChart args={args} data={defaultData} />,
};
...
export const NegativeVertical: Story = {
  ...
  render: (args) => <AgStackedBarChart args={args} data={negativeData} />,
};
