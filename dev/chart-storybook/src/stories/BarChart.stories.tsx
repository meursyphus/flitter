...
function ToastBarChart({ args, data }: { args: BarChartArgs; data: typeof defaultData }) {
...
const meta: Meta<BarChartArgs> = {
  ...
  argTypes: {
    ...
    barCornerRadius: { control: { type: "range", min: 0, max: 20, step: 1 } },
...
export const Vertical: Story = {
  render: (args) => <ToastBarChart args={args} data={defaultData} />,
};
...
export const NegativeVertical: Story = {
  ...
  render: (args) => <ToastBarChart args={args} data={negativeData} />,
};
