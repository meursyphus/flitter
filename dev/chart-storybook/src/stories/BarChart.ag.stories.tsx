...
function AgBarChart({ args, data }: { args: BarChartArgs; data: typeof defaultData }) {
...
export const Vertical: Story = {
  render: (args) => <AgBarChart args={args} data={defaultData} />,
};
...
export const NegativeVertical: Story = {
  ...
  render: (args) => <AgBarChart args={args} data={negativeData} />,
};
