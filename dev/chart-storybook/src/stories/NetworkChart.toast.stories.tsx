...
import { ToastNetworkChart } from "shared/chart";
...
export const SocialGraph: Story = {
  render: (args) => (
    <Widget widget={ToastNetworkChart({ data: socialGraph })} width="700px" height="420px" renderer={args.renderer} />
  ),
};

export const ProductDependencies: Story = {
  render: (args) => (
    <Widget widget={ToastNetworkChart({ data: productGraph })} width="700px" height="420px" renderer={args.renderer} />
  ),
};
