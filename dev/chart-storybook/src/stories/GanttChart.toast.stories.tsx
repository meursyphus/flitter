...
import { ToastGanttChart } from "shared/chart";
...
export const Roadmap: Story = {
  render: (args) => (
    <Widget widget={ToastGanttChart({ data: roadmap })} width="820px" height="360px" renderer={args.renderer} />
  ),
};

export const Operations: Story = {
  render: (args) => (
    <Widget widget={ToastGanttChart({ data: operations })} width="820px" height="320px" renderer={args.renderer} />
  ),
};
