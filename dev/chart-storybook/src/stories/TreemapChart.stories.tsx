...
const meta: Meta<StoryArgs> = {
  title: "In-Review/TreemapChart/Ag",
...
export const StorageUsage: Story = {
  render: (args) => (
    <Widget widget={TreemapChart({ data: storageData })} width="700px" height="420px" renderer={args.renderer} />
  ),
};

export const Portfolio: Story = {
  render: (args) => (
    <Widget widget={TreemapChart({ data: portfolioData })} width="700px" height="420px" renderer={args.renderer} />
  ),
};
