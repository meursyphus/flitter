...
export const BarAndLine: Story = {
  render: (args) => (
    <Widget widget={ComboChart({ data: barLineData })} width="760px" height="420px" renderer={args.renderer} />
  ),
};

export const BarAndArea: Story = {
  render: (args) => (
    <Widget widget={ComboChart({ data: areaOverlayData })} width="760px" height="420px" renderer={args.renderer} />
  ),
};
