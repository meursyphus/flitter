...
export const Basic: Story = {
  render: (args) => (
    <Widget widget={ToastCandlestickChart({ data: ohlcData })} width="720px" height="420px" renderer={args.renderer} />
  ),
};

export const MultiMonth: Story = {
  render: (args) => (
    <Widget widget={ToastCandlestickChart({ data: multiMonthData })} width="760px" height="420px" renderer={args.renderer} />
  ),
};
