...
class _AgTooltipArea extends StatefulWidget {
  ...
  constructor({ tooltip, ctx }: { tooltip: Widget | null; ctx: any }) {
    super();
...
class _AgTooltipAreaState extends State<_AgTooltipArea> {
  ...
  override build(): Widget {
    ...
    const children: Widget[] = [
      // Mouse-tracking layer (translucent so bars below still receive hit tests)
      GestureDetector({
...
export function agTooltipArea(
  ...
  return new _AgTooltipArea({ tooltip, ctx });
}
