...
type CustomArgs<T = undefined, TConfig extends object = object> = (args: T, context: BarChartContext<TConfig>) => Widget;

export type BarChartContext<TConfig extends object = object> = BarChartController & { config: TConfig };

export type BarChartCustom<TConfig extends object = object> = {
