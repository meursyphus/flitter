...
type CustomArgs<T = undefined, TConfig extends object = object> = (args: T, context: PieChartContext<TConfig>) => Widget;

export type PieChartContext<TConfig extends object = object> = PieChartController & { config: TConfig };
...
export type PieChartCustom<TConfig extends object = object> = {
