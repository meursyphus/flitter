...
type CustomArgs<T = undefined, TConfig extends object = object> = (args: T, context: BubbleChartContext<TConfig>) => Widget;

export type BubbleChartContext<TConfig extends object = object> = BubbleChartController & { config: TConfig };
...
export type BubbleChartCustom<TConfig extends object = object> = {
