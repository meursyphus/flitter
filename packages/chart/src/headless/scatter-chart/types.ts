...
type CustomArgs<T = undefined, TConfig extends object = object> = (args: T, context: ScatterChartContext<TConfig>) => Widget;

export type ScatterChartContext<TConfig extends object = object> = ScatterChartController & { config: TConfig };
...
export type ScatterChartCustom<TConfig extends object = object> = {
