...
nav_title: Expanded
title: "Expanded"
description: "Row、Column、Flex内で子要素を利用可能なスペースいっぱいに拡張するウィジェット"
---

## 概要

Expandedは、Row、Column、Flexウィジェット内で子要素を主軸方向の利用可能なスペースいっぱいに拡張するウィジェットです。

Expandedは、`fit: FlexFit.tight`が適用されたFlexibleウィジェットの特殊ケースです。これは子ウィジェットに割り当てられたすべてのスペースを占有することを強制します。複数のExpandedウィジェットが存在する場合、スペースはそれぞれのflex値に応じて比例配分されます。
