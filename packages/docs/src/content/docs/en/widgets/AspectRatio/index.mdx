...
AspectRatio is a widget that attempts to size its child to a specific aspect ratio (width-to-height ratio).
...
For example, if aspectRatio is 2.0, the width will be twice the height (16:9 is expressed as 16/9 = 1.78).
