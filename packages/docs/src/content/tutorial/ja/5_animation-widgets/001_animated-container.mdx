---
title: "Smooth Animations with AnimatedContainer"
description: "Create implicit animations that smoothly transition size, color, and position using AnimatedContainer"
files:
  App.js: |
