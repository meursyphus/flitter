            ...
            child: Column({
              children: [
                Container({
                  ...
                  color: '#FF6B6B',
                  child: Center({
                    child: Text("첫 번째 박스", { style: new TextStyle({ color: 'white' }) })
                  })
                }),
                Container({
                  width: 200,
                  ...
                  color: '#4ECDC4',
                  child: Center({
                    child: Text("두 번째 박스", { style: new TextStyle({ color: 'white' }) })
                  })
                }),
                Container({
                  width: 200,
                  ...
                  color: '#45B7D1',
                  child: Center({
                    child: Text("세 번째 박스", { style: new TextStyle({ color: 'white' }) })
                  })
                })
              ]
            })
